...
void test_reverse()
{
	...
	cout<<"The reverse of "<<c.reverse()<<" is "<<c.reverse()<<endl;
	cout<<"The reverse of "<<d.reverse()<<" is "<<d.reverse()<<endl;
	cout<<"The reverse of "<<m.reverse()<<" is "<<m.reverse()<<endl;
}
...
//	cout<<"Index of 'k' in "<<d<<" is "<<c.indexOf('k')<<endl;
//}
